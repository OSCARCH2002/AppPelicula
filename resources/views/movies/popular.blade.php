...
@section('title', 'Películas Populares - Mi App de Películas')

@section('content')
<div class="space-y-6 sm:space-y-8">
    <!-- Header -->
    <div class="border-l-4 border-cyan-400 pl-3 sm:pl-4">
        <h1 class="text-2xl sm:text-3xl lg:text-4xl font-bold text-white">Películas Populares</h1>
    ...
    @else
        <div class="text-center py-12 sm:py-16 bg-slate-800 rounded-lg">
            ...
            <h3 class="text-lg sm:text-xl font-semibold mb-2 text-white">No hay películas populares disponibles</h3>

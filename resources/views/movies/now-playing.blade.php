...
@section('title', 'En Cines - Mi App de Películas')

@section('content')
<div class="space-y-8">
    <!-- Header -->
    <div class="border-l-4 border-green-400 pl-4">
        <h1 class="text-4xl font-bold text-white">En Cines</h1>
        <p class="text-gray-400">Las películas que están en cartelera</p>
        @if(isset($paginator))
    ...
    @else
        <div class="text-center py-16 bg-slate-800 rounded-lg">
            ...
            <h3 class="text-xl font-semibold mb-2 text-white">No hay películas en cines disponibles</h3>
